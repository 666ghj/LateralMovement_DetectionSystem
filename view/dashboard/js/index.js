            ...
            series : [
                {
                    ...
                    type:'bar',
                    barWidth:'30',
                    data:[1212, 997, 779, 657, 426, 215, 158],
                    itemStyle: {
                        normal: {
                            color:"#1afffd"
                        }
...
//恶意程序境外传播源IP数量按所属家族分布情况
    $(function(){
        ...
        var option = {
            ...
            yAxis: {
                type: 'category',
                data: ['mozi','mirai','hajime','gafgyt','loligang'],
                splitLine: {
                    show: false
                },
                axisLabel: {
            ...
            series: [
                {
                    ...
                    data: [16.78, 6.54, 3.90,2.22, 0.776],
                    itemStyle: {
                        normal: {
                            color:"#45c0ff"
                        }
            ...
            series : [
                {
                    ...
                    type:'line',
                    stack: '个',
                    data:[7.15, 12.95, 19.80, 23.56, 22.38, 36.54, 31.82,36.61,26.86,74.94,37.50,27.01],
                    itemStyle: {
                        normal: {
                            color:"#1afffd"
                        }
    ...
    $(function(){
        ...
        var option = {
            ...
            xAxis : [
                {
                    type : 'category',
                    data:['Dofloo', 'Moobot', 'Mirai', 'Gafgyt', 'Dark_nexus', 'Cayosin'],
            ...
            series : [
                {
                    ...
                    type:'bar',
                    barWidh:'30',
                    data:[8.47, 6.58, 3.98, 0.92, 0.46, 0.37],
                    itemStyle: {
                        normal: {
                            color:"#269fec"
                        }
    ...
    $(function(){
        ...
        var option = {
            ...
            legend: {
                orient: 'vertical',
                x: 'right',
                data: ['命令注入攻击','Web应用攻击','远程代码执行',"漏洞利用攻击",'其他'],
                textStyle:{
                    color:"#e9ebee"
                }
            },
            series : [
                {
                    ...
                    center: ['50%', '60%'],
                    data:[
                        {value:222, name:'命令注入攻击',
                            iteStyle:{
                                normal:{
                                    color:"#2e7cff"
                                }
                            }},
                        {value:254, name:'Web应用攻击',
                            itemStyle:{
                                normal:{
                                    color:"#ffcb89"
                                }
                            }},
                        {value:281, name:'远程代码执行',
                            itemStyle:{
                                normal:{
                                    color:"#e15828"
                                }
                            }},
                        {value:181, name:'漏洞利用攻击',
                        itemStyle:{
                            normal:{
                                color:"#258284"
                                }
