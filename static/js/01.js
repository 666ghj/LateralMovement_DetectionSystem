    ...
    if (jQuery("#dash-chart-03").length) {
      ...
      if(jQuery("#chart-apex-column-01").length){
        var options = {
          series: [{
          name: '全部事件',
          data: [115, 93, 75, 102, 144, 60, 71]
        }, {
          name: '异常事件',
          data: [21, 16, 32, 12, 47, 55, 5]
        }],
        colors: ['#1f1f7a', '#D92815'],
          chart: {
          height: 265,
          fontFamily: 'DM Sans',
          toolbar:{
        ...
        xaxis: {
          ...
          categories: ["2024-07-30T00:00:00.000Z", "2024-07-30T01:30:00.000Z", "2024-07-30T02:30:00.000Z", "2024-07-30T03:30:00.000Z", "2024-07-30T04:30:00.000Z", "2024-07-30T05:30:00.000Z", "2024-07-30T06:30:00.000Z"]
        },
        tooltip: {
          x: {
